...
public enum KareError {
    ...
    INVALID_EXERCISE_DETAILS("error_invalid_exercise_details", ErrorType.INTERNAL),
    ...
    EXERCISE_DETAILS_NOT_FOUND("error_exercise_details_not_found", ErrorType.INTERNAL),
