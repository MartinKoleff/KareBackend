...
public interface WorkoutRepository extends JpaRepository<Workout, Long> {
    ...
    void deleteWorkoutByWorkoutId(Long workoutId);
    ...
    @Modifying
    @Query("UPDATE Workout w SET w.name = :name, w.muscleGroupId = :muscleGroupId, w.snapshot = :snapshot, w.totalExercises = :totalExercises, w.isFavorite = :isFavorite WHERE w.workoutId = :workoutId")
    void updateWorkout(
            @Param("name") String name,
            @Param("muscleGroupId") int muscleGroupId,
            @Param("snapshot") String snapshot,
            @Param("totalExercises") int totalExercises,
